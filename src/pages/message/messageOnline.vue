    ...
    <div class="wrap">
        <div class="subContent zr-row">
            <el-tabs type="card" v-model="tabItem" @tab-click="handleClick">
                ...
                <!-- <el-tab-pane label="巡更消息" name="table5">
                    <div class="tableWrap" v-if="tabItem === 'table5'"> -->
                       ...
                       <!-- <el-table ref="table2" stripe :data="tableData" style="width: 100%;margin-top:14px;"
                            ...
                            <!-- 消息来源 -->
                            <!-- <el-table-column :show-overflow-tooltip="true" prop="msgSource" align="center"
                ...
                <!-- <el-tab-pane label="会议室消息" name="table6">
               ...
               <!-- <el-tab-pane label="停车场消息" name="table7">
                ...
                <!-- <el-tab-pane label="充电桩消息" name="table8">
                    <div class="tableWrap" v-if="tabItem === 'table8'"> -->
                        <!--搜索功能-->
                        <!-- <el-form :inline="true" :model="searchForm" class="zr-row-scatter">
                            <div>
                                <el-checkbox v-model="checked" @change="showIsRead" style="margin-right: 20px;">显示已读</el-checkbox>
                ...
                <el-tab-pane label="报警通知" name="table9">
                    <div class="tableWrap" v-if="tabItem === 'table9'">
                        <!--搜索功能-->
                        <el-form :inline="true" :model="searchForm" class="zr-row-scatter">
                            <div>
                                <el-checkbox v-model="checked" @change="showIsRead" style="margin-right: 20px;">显示已读</el-checkbox>
                        ...
                        <!--数据表格渲染-->
                        <el-table ref="table9" stripe :data="tableData" style="width: 100%;margin-top:14px;"
                                  @selection-change="onSelect">
                            <el-table-column type="selection" width="60"></el-table-column>
                            <el-table-column :show-overflow-tooltip="true" type="index" label="序号" align="center"
                                             width="50"></el-table-column>
                ...
                <el-tab-pane label="工单消息" name="table10">
                    <div class="tableWrap" v-if="tabItem === 'table10'">
                        <!--搜索功能-->
                        <el-form :inline="true" :model="searchForm" class="zr-row-scatter">
                            <div>
                                <el-checkbox v-model="checked" @change="showIsRead" style="margin-right: 20px;">显示已读</el-checkbox>
                        ...
                        <!--数据表格渲染-->
                        <el-table ref="table10" stripe :data="tableData" style="width: 100%;margin-top:14px;"
                                  @selection-change="onSelect">
                            <el-table-column type="selection" width="60"></el-table-column>
                            <el-table-column :show-overflow-tooltip="true" type="index" label="序号" align="center"
                                             width="50"></el-table-column>
                ...
                <el-tab-pane label="保养消息" name="table11">
                    <div class="tableWrap" v-if="tabItem === 'table11'">
                        <!--搜索功能-->
                        <el-form :inline="true" :model="searchForm" class="zr-row-scatter">
                            <div>
                                <el-checkbox v-model="checked" @change="showIsRead" style="margin-right: 20px;">显示已读</el-checkbox>
                        ...
                        <!--数据表格渲染-->
                        <el-table ref="table11" stripe :data="tableData" style="width: 100%;margin-top:14px;"
                                  @selection-change="onSelect">
                            <el-table-column type="selection" width="60"></el-table-column>
                            <el-table-column :show-overflow-tooltip="true" type="index" label="序号" align="center"
                                             width="50"></el-table-column>
                ...
                <el-tab-pane label="服务消息" name="table12">
                    <div class="tableWrap" v-if="tabItem === 'table12'">
                        <!--搜索功能-->
                        <el-form :inline="true" :model="searchForm" class="zr-row-scatter">
                            <div>
                                <el-checkbox v-model="checked" @change="showIsRead" style="margin-right: 20px;">显示已读</el-checkbox>
                        ...
                        <!--数据表格渲染-->
                        <el-table ref="table12" stripe :data="tableData" style="width: 100%;margin-top:14px;"
                                  @selection-change="onSelect">
                            <el-table-column type="selection" width="60"></el-table-column>
                            <el-table-column :show-overflow-tooltip="true" type="index" label="序号" align="center"
                                             width="50"></el-table-column>
                ...
                <el-dialog :close-on-click-modal="false" title="消息详情" :visible.sync="formDialogVisible"
                    ...
                    <el-form :model="editform" ref="editform" label-width="80px">
                        ...
                        <div style="text-align:left;margin-bottom:40px;text-indent:2rem;font-size: 14px;" v-html="editform.content">
    ...
    export default {
        ...
        methods: {
            handleClick(tab, event) {
                ...
                switch(this.tabItem){
                        ...
                        case 'table7'://停车场消息
                               ...
                               break;
                        case 'table8'://充电桩消息
                               return this.loadTable('table8');
                               break;
                        case 'table9'://报警通知 3
                               return this.loadTable('table9');
                               break;
                        case 'table10'://工单消息 5
                               return this.loadTable('table10');
                               break;
                        case 'table11'://保养消息   4
                               return this.loadTable('table11');
                               break;
                        case 'table12'://服务消息 1
                               return this.loadTable('table12');
                               break;
                        default:
                                break;
                    }
            ...
            loadTable(type) {
                ...
                if (type == 'table9') {//报警通知 3
                    Object.assign(param, {msgType: "3"});
                    if(this.showRead == 1){
                        this.checked = true
                    }else{
                       this.checked = false
                ...
                if (type == 'table10') {//工单 5
                    Object.assign(param, {msgType: "5"});
                    if(this.showRead ==1){
                        this.checked = true
                    }else{
                       this.checked = false
                ...
                if (type == 'table11') {//保养   4
                    Object.assign(param, {msgType: "4"});
                    if(this.showRead == 1){
                        this.checked = true
                    }else{
                       this.checked = false
                ...
                if (type == 'table12') {//服务消息   1
                    Object.assign(param, {msgType: "1"});
                    if(this.showRead ==1){
                        this.checked = true
                    }else{
                       this.checked = false
            ...
            dealWith(){
                ...
                switch(this.blMsgType){
                        case '缴费信息':
                               return this.$router.push('/meter/chargeCenter');
                               break;
                        case '报警通知':
                                return this.$router.push('/alarm/alarm');
                                break;
                        case '保养信息':
                               return this.$router.push('/device/maintainTask');
                               break;
                        case '工单信息':
                               return this.$router.push('/customService/gdgl');
                               break;
                       case '服务消息':
                               return this.$router.push('/customService/serviceStation');
                               break;
                        default:
                                break;
                    }
