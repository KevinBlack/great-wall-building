...
<!--						<el-button type="primary" @click="search()">导出</el-button>-->
			...
			<!-- 选择房产信息
		<el-dialog   title="所属区域" :visible.sync="houseTreeVisible">
			<template>
	        	...
	        	<el-form :model="formInline" :rules="rules" ref="formInline" label-width="80px" class="w-80" style="margin:0 auto">
                    ...
                    <el-col :span="24">
						<el-form-item label="邮箱" >
							<el-input v-model="formInline.email" disabled></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="是否在职" prop="job">
		                    <el-select v-model="formInline.job" placeholder="是否在职" disabled style="width: 200px;">
			...
			<!--编辑弹出窗-->
			<el-dialog   :title="peopleDailogTitle" :visible.sync="editTableVisible" width="50%">
				<el-form :model="editform" :rules="rules" ref="editform" label-width="80px" class="w-80" style="margin:0 auto">
					...
					<el-col :span="24" v-if="editform.id">
						<el-form-item label="是否在职" prop="job">
		                    <el-select v-model="editform.job" placeholder="是否在职" class="w-50">
		                        <el-option label="是" value="是"></el-option>
		                        <el-option label="否" value="否"></el-option>
		                    </el-select>
		                </el-form-item>
...
<script>
	...
	export default {
		...
		methods: {
			...
			toAdd(index, row) {
				this.getCompanys();
				this.peopleDailogTitle="新增员工";
				this.editform = {};
				this.editform.job = "是";
				// this.$http('get', '/manage/houseProperty/findAreaNameByLoginUser', {}).then(res => {
				// 	this.houseFunctionOption = res.data.body;
	            // })
				this.$forceUpdate();
			...
			selectHouseSave() {
				...
				this.$httpGet('get', '/manage/houseProperty/findAreaNameByIds', {
					...
					this.editform.area = res.data.body.areaName;
