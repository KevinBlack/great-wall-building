        ...
        <div class="subContent">
            <div class="tableWrap">
                ...
                <el-table ref="table" stripe :data="tableData" style="width: 100%" @selection-change="onSelect">
                    ...
                    <el-table-column :show-overflow-tooltip="true" prop="deviceClassName" label="保养设备"></el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true" prop="deviceSystemName" label="保养描述"></el-table-column>
                    <el-table-column :show-overflow-tooltip="true" prop="deviceSystemName" label="保养提醒时间"></el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true" prop="maintainType" :formatter="getMaintainType" label="保养类型"></el-table-column>-->
                    <el-table-column :show-overflow-tooltip="true" label="保养登记" width="180">
                        <template slot-scope="scope">
                        	<el-button @click.native.prevent="toEdit(scope.$index, scope.row)" type="text" size="mini" v-if="scope.row.isRemind == 1">
                                保养登记
                            </el-button>
                            <el-button disabled type="text" size="mini" v-else>
                                保养登记
                            </el-button>
                        </template>
                    </el-table-column>
							...
							<div class="b-0 p-20">
								<el-col :span="8">
		                            <el-form-item label="设备编号" prop="deviceId">
		                                <!-- 设备编号 -->
		                                <el-input v-model="editform.deviceId" disabled  @blur.prevent="queryByDeviceCode()"></el-input>
		                            </el-form-item>
	                            </el-col>
	                            <el-col :span="8">
                ...
                <el-form  :model="editform" :rules="rules" ref="editform"  label-width="120px">
                        <el-row class="m-t-10">
							...
							<div class="b-0 p-20">
		                        ...
		                        <el-col :span="8">
		                            <el-form-item label="设备系统" prop="deviceTypeName">
		                                <el-input v-model="editform.deviceTypeName" disabled></el-input>
		                            </el-form-item>
		                        </el-col>
	                            <!--<el-col :span="8">
		                         ...
		                         <el-col :span="8">
		                            ...
		                            <el-form-item label="保养开始日期" prop="startTime">
		                                <el-date-picker v-model="editform.startTime" type="datetime" value-format="timestamp"
		                                                format="yyyy-MM-dd HH:mm" placeholder="保养开始日期" :disabled="isDetail">
		                                </el-date-picker>
		                            </el-form-item>
		                        </el-col>
		                         <el-col :span="8" >
	                                ...
	                                <el-form-item label="保养结束日期" prop="endTime">
	                                    <el-date-picker v-model="editform.endTime" type="datetime" value-format="timestamp"
	                                            format="yyyy-MM-dd HH:mm" placeholder="保养结束日期" :disabled="isDetail">
	                                    </el-date-picker>
	                                </el-form-item>
	                            </el-col>
		                    </div>
