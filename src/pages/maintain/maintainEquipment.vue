            ...
            <div class="tableWrap">
                ...
                <el-table ref="table" stripe :data="tableData" style="width: 100%" @selection-change="onSelect">
                    ...
                    <el-table-column :show-overflow-tooltip="true" type="index" label="序号" width="50"></el-table-column>
                     <!-- 保养设备 -->
                    <el-table-column :show-overflow-tooltip="true" prop="deviceName" label="保养设备"></el-table-column>
                    <!-- 设备编号 -->
                    <el-table-column :show-overflow-tooltip="true" prop="deviceId" label="设备编号"></el-table-column>
                    <!-- 保养开始日期 -->
                    <el-table-column :show-overflow-tooltip="true" prop="startTime" label="保养开始日期" :formatter="dateFormat" width="120"></el-table-column>
                    <!-- 保养结束日期 -->
                    <el-table-column :show-overflow-tooltip="true" prop="endTime" label="保养结束日期" :formatter="dateFormat" width="120"></el-table-column>
                    <!-- 保养负责人 -->
                    <el-table-column :show-overflow-tooltip="true" prop="maintainUserId" label="保养负责人" width="100"></el-table-column>
                    <!-- 保养描述
							...
							<div class="b-0 p-20">
								<el-col :span="12">
		                            <el-form-item label="保养类型" prop="maintainType">
		                                <!-- 保养类型 1周期保养 2动态运行保养 -->
		                                <el-select v-model="editform.maintainType" placeholder="保养类型" :disabled="isDetail">
					                        <el-option label="周期保养" value="1"></el-option>
					                        <el-option label="动态运行保养" value="2"></el-option>
					                    </el-select>
		                            </el-form-item>
